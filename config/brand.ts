...
export const BRAND: BrandConfig = {
  businessName: "Madhu's Jewellers",
  tagline: "Fine Jewellery in Chalakudy",
  description:
    "Madhu's Jewellers is Chalakudy's trusted destination for exquisite gold, diamond, and silver jewellery. Serving Chalakudy and the surrounding areas with timeless craftsmanship and contemporary designs for every celebration.",
  ...
  seo: {
    title: "Madhu's Jewellers | Jewellery in Chalakudy",
    description:
      "Madhu's Jewellers — your premier jewellery store in Chalakudy. Gold, diamond and silver jewellery crafted for every occasion. Visit us in Chalakudy, Kerala.",
    keywords: [
      "Madhu's Jewellers",
      "jewellery Chalakudy",
  ...
  whatsappMessage:
    "Hello Madhu's Jewellers, I'd like to know more about your jewellery collections.",
};
